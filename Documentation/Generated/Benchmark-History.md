...
| --- | --- | --- | --- | --- | --- | --- | ---: | ---: | ---: | --- |
| `v1.2.1` | release | `v1.2.1` | `699df19bf219` | `2026-04-15T13:00:40Z` | `2026-04-15T13:01:36Z` | `local-directory` | 55.55 | 0.0785 | 25 | [summary](../../Benchmarks/Results/releases/v1.2.1/benchmark-summary.md) |
| `latest` | latest | `latest` | `n/a` | `2026-04-15T13:00:40Z` | `n/a` | `local-directory` | 55.55 | 0.0785 | 25 | [summary](../../Benchmarks/Results/latest/benchmark-summary.md) |
...
| --- | --- | --- | --- | --- | --- | --- | ---: | ---: | --- |
| `v1.2.1` | Mac | `muhittin-macbook-pro-2.local` | `arm64` | `macOS` | `Version 26.4.1 (Build 25E253)` | `local-directory` | 18 | 48.0 | `standard` |
| `latest` | Mac | `muhittin-macbook-pro-2.local` | `arm64` | `macOS` | `Version 26.4.1 (Build 25E253)` | `local-directory` | 18 | 48.0 | `standard` |
