...
| --- | --- | --- | --- | --- | --- | --- | ---: | ---: | ---: | --- |
| `latest` | latest | `latest` | `n/a` | `2026-04-08T18:03:48Z` | `n/a` | `local-directory` | 56.50 | 0.0766 | 25 | [summary](../../Benchmarks/Results/latest/benchmark-summary.md) |
...
| --- | --- | --- | --- | --- | --- | --- | ---: | ---: | --- |
| `latest` | Mac | `muhittin-macbook-pro-2.local` | `arm64` | `macOS` | `Version 26.4 (Build 25E246)` | `local-directory` | 18 | 48.0 | `standard` |
