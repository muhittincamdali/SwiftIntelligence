...
bash "$ROOT_DIR/Scripts/generate-proof-snapshot.sh" "$RESULTS_ROOT/latest" "$GENERATED_DIR/Proof-Snapshot.md"
...
bash "$ROOT_DIR/Scripts/validate-benchmarks.sh" standard "$RESULTS_ROOT/latest"
bash "$ROOT_DIR/Scripts/validate-transfer-chain.sh" "$RESULTS_ROOT/latest"
...
bash "$ROOT_DIR/Scripts/validate-benchmark-thresholds.sh" "$RESULTS_ROOT/latest" "$RESULTS_ROOT" "$ROOT_DIR/Benchmarks/benchmark-thresholds.json"
